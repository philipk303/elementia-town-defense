...
const OUT = path.join(ROOT, 'client/src/render/contentBoxes.js')
...
const KEYS = [
  // structures — fitted to their footprint by structureVisuals.js
  ...
  // actors — scaled against their gameplay radius by actorVisuals.js. Their
  // art was authored at unrelated sizes: goblin/orc/troll drew at 22/23/25px
  // for hitboxes of 14/18/24 (a 1.7x gameplay spread rendered as 1.14x), and
  // the four chibi elements drew at 43/38/33/25px for one shared 28px hitbox.
  'goblin', 'orc', 'troll',
  'chibi_earth', 'chibi_fire', 'chibi_water', 'chibi_wind',
]
